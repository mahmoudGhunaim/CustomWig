...
const HairColor = ({
  ...
  const [svgHairHighlightcolor, setSvgHairHighlightcolor] = useState("");
  ...
  setMoreItemsVisible(activeFilter); // Trigger visibility change for more items
  ...
  const handleResetColor = (tab) => {
    setSelectedColors((prevColors) => ({
      ...prevColors,
      [tab]: null, // إعادة تعيين اللون إلى القيمة الافتراضية
    }));
  
    setSelectedPrice((prevPrices) => ({
      ...prevPrices,
      [tab]: 0, // إعادة تعيين السعر إلى 0 إذا لزم الأمر
    }));
  };
    ...
    if (lastSelected === "Wavy") {
      ...
      setSvgHairHighlightcolor(
        <svg width="350" height="571" viewBox="0 0 350 571" fill="none" xmlns="http://www.w3.org/2000/svg" className="highlightcolor-svg">
          ...
          <path d="M179 149.5V30C174.5 48.5 165 230.5 165 253.5C165 276.5 188.5 313.5 183.5 304C178.5 294.5 179 173.5 179 149.5Z" fill={selectedColors.highlight}  />
          </svg>
      ...
      <div className="HairColor-container" id="Haircolor">
        ...
        <div className="HairColor-detail">
          <div className="HairColor-tabs">
            ...
            onClick={() => handleResetColor(activeTab)}
          >
            {getTranslation("reset_color", "Reset Color")}
          </button>
          </div>
